...
- **ECR Repositories**: g5-slabai-payment-service, g5-slabai-project-service, g5-slabai-user-service, g5-slabai-frontend
...
1. **Push Docker Images to ECR**:
   ...
   docker tag payment:latest <account-id>.dkr.ecr.us-west-2.amazonaws.com/g5-slabai-payment-service:latest
   docker push <account-id>.dkr.ecr.us-west-2.amazonaws.com/g5-slabai-payment-service:latest
   
   docker tag project:latest <account-id>.dkr.ecr.us-west-2.amazonaws.com/g5-slabai-project-service:latest
   docker push <account-id>.dkr.ecr.us-west-2.amazonaws.com/g5-slabai-project-service:latest
   
   docker tag user:latest <account-id>.dkr.ecr.us-west-2.amazonaws.com/g5-slabai-user-service:latest
   docker push <account-id>.dkr.ecr.us-west-2.amazonaws.com/g5-slabai-user-service:latest
...
aws ecr describe-repositories --region us-west-2 --repository-names g5-slabai-payment-service g5-slabai-project-service g5-slabai-user-service g5-slabai-frontend
